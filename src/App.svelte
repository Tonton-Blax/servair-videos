<script>
	...
	const videos = [
		...
		{ title: "SIAAR activité non aérienne", src: "CHRISTIAN-JOSSE", names: "Christian JOSSE", dpt: "Développement des Nouveaux Marchés"},
		{ title: "Maitriser la matière MMAT", src: "DANIELA-RAMIREZ", names: "Daniela RAMIREZ", dpt: "Process Industriels"},
		{ title: "Les Collections Culinaires Servair", src: "DELPHINE-DISTEFANO", names: "Delphine DI STEFANO", dpt: "Développement des Nouveaux Marchés"},
